...
let projects = [
  ...
  // },
  {
    ...
    description: (
      <div>
        ...
        <a href="https://codepen.io/lwood54/pen/ZxgMKp?editors=0110" target="blank">
          <p>This was completed as part of a Free Code Camp Challenge. I used ReactJS on codepen.io</p>
        </a>
      </div>
    ),
    jsx: (
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <a href="https://codepen.io/lwood54/pen/xWNJvY" target="blank">
          <p>
            This was completed as part of a Free Code Camp Challenge. I used ReactJS and MaterializeCSS on codepen.io. Try to beat the computer or
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <a href="https://codepen.io/lwood54/pen/bvzVvg" target="blank">
          <p>
            This was completed as part of a Free Code Camp Challenge. You can adjust break time and work time while in use. Made with ReactJS and
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <a href="https://codepen.io/lwood54/pen/dmyNEE" target="blank">
          <p>
            This was completed as part of a Free Code Camp Challenge. I used ReactJS and MaterializeCSS as well as Wikipedia's API. You can search
  ...
  },
  {
    ...
    description: (
      <div>
        <div className={cls.faContainer}>
          <a href="https://github.com/lwood54/basic_social_media_web_app" target="blank">
            <FontAwesomeIcon icon={faComments} className={cls.faSymbol} />
          </a>
        </div>
        <a href="https://github.com/lwood54/basic_social_media_web_app" target="blank">
          <p>
            This was one of several projects completed in Andrew Mead's NodeJS course using tools such as MongoDB, NodeJS, Socket.IO, and ExpressJS.
          </p>
        </a>
      </div>
    ),
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <a href="https://github.com/lwood54/expensifyApp" target="blank">
          <p>This was another course I completed by Andrew Mead using React, Firebase, and Redux. </p>
        </a>
      </div>
    ),
    jsx: (
...
let initialProjList = projects.map((project, i) => {
  if (i === projects.length - 1) {
    return (
      ...
      <div className={[cls.MoveCenterToLeft, cls.DispProjContents].join(" ")} key={Math.random() * 8}>
    ...
    return (
      <div className={[cls.MoveRightToCenter, cls.DispProjContents].join(" ")} key={Math.random() * 8}>
        <h2 className={cls.projTitle}>{project.title}</h2>
        {project.jsx}
        <div className={cls.projDescription}>{project.description}</div>
      </div>
    ...
    return (
      <div className={[cls.MoveInToRight, cls.DispProjContents].join(" ")} key={Math.random() * 8}>
        <h2 className={cls.projTitle}>{project.title}</h2>
        {project.jsx}
        <div className={cls.projDescription}>{project.description}</div>
      </div>
